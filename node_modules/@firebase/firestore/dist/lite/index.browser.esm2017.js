...
class __PRIVATE_DatastoreImpl extends class Datastore {} {
    ...
    /** Invokes the provided RPC with auth and AppCheck tokens. */    R(t, e, r) {
        return this.Z(), Promise.all([ this.authCredentials.getToken(), this.appCheckCredentials.getToken() ]).then((([n, i]) => this.connection.R(t, e, r, n, i))).catch((t => {
    ...
    /** Invokes the provided RPC with streamed results with auth and AppCheck tokens. */    g(t, e, r, n) {
        return this.Z(), Promise.all([ this.authCredentials.getToken(), this.appCheckCredentials.getToken() ]).then((([i, s]) => this.connection.g(t, e, r, i, s, n))).catch((t => {
            throw "FirebaseError" === t.name ? (t.code === p && (this.authCredentials.invalidateToken(), 
            this.appCheckCredentials.invalidateToken()), t) : new FirestoreError(A, t.toString());
        }));
    }
...
async function __PRIVATE_invokeRunAggregationQueryRpc(t, e, r) {
    var n;
    const i = __PRIVATE_debugCast(t), {request: s, X: o} = function __PRIVATE_toRunAggregationQueryRequest(t, e, r) {
...
function doc(t, e, ...r) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = __PRIVATE_AutoId.D()), __PRIVATE_validateNonEmptyArgument("doc", "path", e), 
...
class __PRIVATE_TransactionRunner {
    ...
    Rt(t) {
        this.Et > 0 && this.It(t) ? (this.Et -= 1, this.asyncQueue.enqueueAndForget((() => (this.Tt(), 
 ...
 */ class __PRIVATE_AsyncQueueImpl {
    ...
    enqueue(t) {
        ...
        return this.Nt((() => this.wt && this.Dt ? Promise.resolve() : (t().then(e.resolve, e.reject), 
        e.promise))).then((() => e.promise));
    }
    enqueueRetryable(t) {
        this.enqueueAndForget((() => (this.yt.push(t), this.Ot())));
    }
    /**
 ...
 */ (t)) throw t;
 // Failure will be handled by AsyncQueue
    ...
    Nt(t) {
        const e = this.Vt.then((() => (this.vt = !0, t().catch((t => {
            this.Ft = t, this.vt = !1;
            const e = 
            /**
 ...
 */ (n, e), n);
    ...
    registerVersion("firestore-lite", "4.3.0", ""), registerVersion("firestore-lite", "4.3.0", "esm2017");
}();
