 ...
 * limitations under the License.
 */
var v = "10.5.0", w = new l("@firebase/firestore");
 ...
 */ var Xt = function() {}, Zt = /** @class */ function(e) {
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).filters = t, r.op = n, r.C = null, r;
    }
    /**
     * Creates a filter based on the provided arguments.
     */    return t(n, e), n.create = function(t, e) {
        ...
        return null !== this.C || (this.C = this.filters.reduce((function(t, e) {
 ...
 */ function Se(t) {
    ...
    if (null === e.N) {
        ...
        for (var n = new Set, r = 0, i = e.explicitOrderBy; r < i.length; r++) {
            var o = i[r];
            e.N.push(o), n.add(o.field.canonicalString());
        }
        ...
        // field to be sorted last.
            ...
            n.has(t.canonicalString()) || t.isKeyField() || e.N.push(new ce(t, a));
        })), 
        // Add the document key field to the last if it is not explicitly ordered.
        n.has(rt.keyField().canonicalString()) || e.N.push(new ce(rt.keyField(), a));
    }
    return e.N;
}
...
/** Used to represent a field transform on a mutation. */ var Ve = function() {
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).serializer = t, r.B = n, r;
    }
    return t(n, e), n;
}(Ve), Re = function(t, e) {
 ...
 */ var fn = /** @class */ function() {
    ...
    /** Invokes the provided RPC with auth and AppCheck tokens. */ n.prototype.R = function(t, e, n) {
        var r = this;
        return this.Z(), Promise.all([ this.authCredentials.getToken(), this.appCheckCredentials.getToken() ]).then((function(i) {
            var o = i[0], a = i[1];
                ...
                return a = n.sent(), u = new Map, a.forEach((function(t) {
                    var n = function(t, e) {
                        return "found" in e ? function(t, e) {
                            ...
                            var n = Xe(t, e.found.name), r = Ye(e.found.updateTime), i = e.found.createTime ? Ye(e.found.createTime) : fe.min(), o = new ve({
                                mapValue: {
 ...
 */ function bn(t, e, n, r) {
    var i;
    void 0 === r && (r = {});
    var o = (t = ct(t, vn))._getSettings(), a = "".concat(e, ":").concat(n);
 ...
 * terminated.
 */ function Tn(t) {
    return t = ct(t, vn), s(t.app, "firestore/lite"), t._delete();
}
 ...
 */ function Pn(t, e) {
    ...
    if (t = p(t), ot("collection", "path", e), t instanceof vn) {
 ...
 */ function Vn(t, e) {
    if (t = ct(t, vn), ot("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new B(F, "Invalid collection ID '".concat(e, "' passed to function collectionGroup(). Collection IDs must not contain '/'."));
    return new kn(t, 
...
/** Parse update data from a list of field/value arguments. */ function $n(t, e, n, r, i, o) {
    ...
    for (var l = [], f = ve.empty(), h = u.length - 1; h >= 0; --h) if (!cr(l, u[h])) {
        ...
        l.push(d); else {
            var g = er(y, m);
            null != g && (l.push(d), f.set(d, g));
        }
    }
    var v = new ge(l);
    return new Mn(f, v, a.fieldTransforms);
}
...
function jr(t, e) {
    if (!(e instanceof vr || e instanceof _r)) throw new B(F, "Function ".concat(t, "() requires AppliableConstraints created with a call to 'where(...)', 'or(...)', or 'and(...)'."));
}
                  ...
                  case 1:
                    return [ 2 /*return*/ , n.sent().filter((function(t) {
                        ...
                        return function(t, e, n) {
                            var r = Xe(t, e.name), i = Ye(e.updateTime), o = e.createTime ? Ye(e.createTime) : fe.min(), a = new ve({
                                mapValue: {
                                    fields: e.fields
                                }
...
function zr(t, e, n) {
    var r = Lr((t = ct(t, In)).converter, e, n), i = Kn(Gn(t.firestore), "setDoc", t._key, r, null !== t.converter, n);
 ...
 */ function Kr(t) {
    return pn(mn((t = ct(t, In)).firestore), [ new Le(t._key, qe.none()) ]);
}
 ...
 */ function Qr(t, e) {
    var n = Fn(t = ct(t, An)), r = Lr(t.converter, e), i = Kn(Gn(t.firestore), "addDoc", n._key, r, null !== n.converter, {});
 ...
 * ```
 */ function Yr(t, r) {
    var i = ct(t.firestore, vn), o = mn(i), a = function(t, e) {
        var n = [];
                ...
                switch (n.label) {
                  case 0:
                    return o = A(t), a = function(t, e, n) {
                        ...
                        e.q = Ie(e, t.explicitOrderBy)), e.q;
                    }(r), i), u = a.request, s = a.X, c = u.parent, o.connection.P || delete u.parent, 
 ...
 */
function mi(t, e, n) {
    var r = mn(t = ct(t, vn)), i = Object.assign(Object.assign({}, ci), n);
    !function(t) {
...
hi = "".concat(i, "_lite"), v = hi, o(new c("firestore/lite", (function(t, e) {
    var n = e.instanceIdentifier, r = e.options, i = t.getProvider("app").getImmediate(), o = new vn(new W(t.getProvider("auth-internal")), new X(t.getProvider("app-check-internal")), function(t, e) {
...
a("firestore-lite", "4.3.0", ""), a("firestore-lite", "4.3.0", "esm5");

export { En as AggregateField, Sn as AggregateQuerySnapshot, Dn as Bytes, An as CollectionReference, In as DocumentReference, lr as DocumentSnapshot, Rn as FieldPath, xn as FieldValue, vn as Firestore, B as FirestoreError, Cn as GeoPoint, kn as Query, _r as QueryCompositeFilterConstraint, mr as QueryConstraint, fr as QueryDocumentSnapshot, Or as QueryEndAtConstraint, vr as QueryFieldFilterConstraint, kr as QueryLimitConstraint, Er as QueryOrderByConstraint, hr as QuerySnapshot, Pr as QueryStartAtConstraint, Dt as Timestamp, yi as Transaction, oi as WriteBatch, Qr as addDoc, Zr as aggregateFieldEqual, $r as aggregateQuerySnapshotEqual, Tr as and, ri as arrayRemove, ni as arrayUnion, Jr as average, Pn as collection, Vn as collectionGroup, bn as connectFirestoreEmulator, Xr as count, Kr as deleteDoc, ti as deleteField, Fn as doc, qn as documentId, Dr as endAt, Nr as endBefore, Yr as getAggregate, Wr as getCount, Ur as getDoc, Br as getDocs, _n as getFirestore, ii as increment, wn as initializeFirestore, Ir as limit, Ar as limitToLast, br as or, Sr as orderBy, gr as query, Nn as queryEqual, On as refEqual, mi as runTransaction, ei as serverTimestamp, zr as setDoc, _ as setLogLevel, pr as snapshotEqual, Fr as startAfter, Vr as startAt, Hr as sum, Tn as terminate, Gr as updateDoc, wr as where, ui as writeBatch };
